...
public class UserSecurity implements UserDetails {
    ...
    public UserSecurity(String userName, String userPass, List<SimpleGrantedAuthority> authorities, boolean isActive) {
    ...
    public static UserDetails fromUser(UserEntity userEntity) {
        return new User(
                userEntity.getEmail(), userEntity.getUserPass(),
